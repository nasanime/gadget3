function recentPosts(json) {
    document.write('<ul class="recent_label_with_thumbs">');
    for (var i = 0; i < numposts; i++) {
        ...
        monthnames[11] = "Nov";
        monthnames[12] = "Dec";
        document.write('<span><li class="clearfix">');
        ...
        if (displaymore == true) {
            ...
            towrite = towrite + '<a href="' + posturl + '" class="url" target ="_top">More Ã‚Â»</a>';
            flag = 1;;
        }
        document.write('<span>' + towrite + '</span>');
